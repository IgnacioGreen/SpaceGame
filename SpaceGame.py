...
# player variables
img_player = pygame.image.load('assets/cohete.png')
player_x = 368
player_y = 500
player_x_change = 0
...
for e in range(amount_enemies):
    img_enemy.append(pygame.image.load('assets/enemigo.png'))
...
# bullet variables
bullets = []
img_bullet = pygame.image.load('assets/bala.png')
bullet_x = 0
bullet_y = 500
bullet_x_change = 0
bullet_y_change = 3
...
# Fonts
bytes_font_points = bytes_fonts('assets/freesansbold.ttf')
font = pygame.font.Font(bytes_font_points, 32)
text_x = 10
text_y = 10

# final text
bytes_font_final_text = bytes_fonts('assets/biergartenli.ttf')
...
while execute:
    ...
    for e in range(amount_enemies):
        ...
        for bullet in bullets:
            ...
            if crash:
                crash_sound = mixer.Sound('assets/Golpe.mp3')
                crash_sound.play()
